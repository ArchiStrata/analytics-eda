...
from analytics_eda.analysis.exploratory_regression_analysis.numeric_numeric_relationship_analysis.relationship_structure_scatter_lowess_plot import (
        ...
        (
            lambda: (lambda n=12:
                     pd.DataFrame({
                         ...
                         "ynum": 1.8*np.arange(n, dtype=float)
                                 + np.array([0,1,-1,0.5,-0.5,1.5,0,-1,0.2,-0.2,0.7,-0.7])
                     }))(),
            "xnum", "ynum",
