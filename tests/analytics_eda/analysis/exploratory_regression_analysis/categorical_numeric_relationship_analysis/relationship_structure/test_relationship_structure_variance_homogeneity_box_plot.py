...
from analytics_eda.analysis.exploratory_regression_analysis.categorical_numeric_relationship_analysis.relationship_structure.relationship_structure_variance_homogeneity_box_plot import (
...
def test_relationship_structure_variance_homogeneity_box_param(make_df, cat_col, kwargs, expect, tmp_path, assert_plot_metadata):
    df = make_df()
