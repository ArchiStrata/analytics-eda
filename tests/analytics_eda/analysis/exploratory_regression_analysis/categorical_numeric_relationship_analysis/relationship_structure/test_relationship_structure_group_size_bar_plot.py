...
from analytics_eda.analysis.exploratory_regression_analysis.categorical_numeric_relationship_analysis.relationship_structure.relationship_structure_group_size_bar_plot import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {
                "chart_metadata": {"xlabel": "Animal", "ylabel": "Count", "data_source": "UnitTest", "file_name": "group_sizes_custom.png"},
                "descriptive_stats": {
                    "total": 10.0,
                    "n_groups": 3,
                },
