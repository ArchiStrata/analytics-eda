...
from analytics_eda.analysis.exploratory_regression_analysis.categorical_numeric_relationship_analysis.magnitude_of_association.magnitude_distribution_overlap_density_plot import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            lambda: _make_normal_groups([("g1", -4, 1.0), ("g2", -2, 1.0), ("g3", 0, 1.0), ("g4", 2, 1.0), ("g5", 4, 1.0)], n_per_group=200, seed=123),
            "group",
