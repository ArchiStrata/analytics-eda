...
from analytics_eda.analysis.exploratory_regression_analysis.categorical_numeric_relationship_analysis.magnitude_of_association.magnitude_central_tendency_anova_kruskal_plot import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            lambda: pd.DataFrame({"value": pd.Series([], dtype=float), "group": pd.Categorical([], categories=["A", "B"])}),
            "group",
            {},
            {
        ...
        (
            lambda: _make_normal_groups([("g1", -4, 1.0), ("g2", -2, 1.0), ("g3", 0, 1.0), ("g4", 2, 1.0), ("g5", 4, 1.0)], n_per_group=150, seed=999),
            "group",
