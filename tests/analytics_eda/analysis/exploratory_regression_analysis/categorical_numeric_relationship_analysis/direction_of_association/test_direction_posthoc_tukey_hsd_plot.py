...
from analytics_eda.analysis.exploratory_regression_analysis.categorical_numeric_relationship_analysis.direction_of_association.direction_posthoc_tukey_hsd_plot import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            lambda: _make_normal_groups([("A", 0.0, 1.0), ("B", 0.10, 1.0)], n_per_group=400, seed=123),
            "group",
            {},
            {
                "descriptive_stats": {
        ...
        (
            lambda: _make_normal_groups([("L", -3.0, 1.0), ("R", 3.0, 1.0)], n_per_group=300, seed=7),
            "group",
            {},
            {
                "descriptive_stats": {
        ...
        (
            lambda: _make_normal_groups([("g1", -1.0, 1.0), ("g2", 0.0, 1.0), ("g3", 1.0, 1.0)], n_per_group=250, seed=99),
            "group",
