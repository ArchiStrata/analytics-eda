...
def test_validate_categorical_named_series_errors(series_factory, expected_exc, match):
    ...
    with pytest.raises(expected_exc, match=match):
        ctx = BalanceRareCategoriesPlotContext()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {},
            {
                "chart_metadata": {"data_source": None, "file_name": None, "title": "Rare Categories of cats", "version": "1.0.0", "xlabel": "Percent of total", "ylabel": "Category"},
                "descriptive_stats": {"bars": {}, "params": {"threshold_type": "proportion", "threshold_value_count": 0, "threshold_value_prop": 0.0}, "subset_count": 0, "total": 0, "total_nonnull": 0},
        ...
        (
            ...
            {
                "chart_metadata": {"data_source": None, "file_name": "rare_prop.png", "title": "Rare Categories of letters", "version": "1.0.0", "xlabel": "Percent of total", "ylabel": "Category"},
                "descriptive_stats": {
                    "bars": {"C": {"count": 1, "pct_of_nonnull": 0.1}, "D": {"count": 1, "pct_of_nonnull": 0.1}},
        ...
        (
            ...
            {
                "chart_metadata": {"data_source": None, "file_name": "rare_count_cap.png", "title": "Rare Categories of mix", "version": "1.0.0", "xlabel": "Percent of total", "ylabel": "Category"},
                "descriptive_stats": {
                    "bars": {"D": {"count": 1, "pct_of_nonnull": 0.1}, "E": {"count": 1, "pct_of_nonnull": 0.1}, "Other (k=2)": {"_is_other": True, "count": 4, "pct_of_nonnull": 0.4}},
                    "denominator_key": "pct_of_nonnull",
                    "input_categories": 4,
        ...
        (
            ...
            {
                "chart_metadata": {"data_source": None, "file_name": None, "title": "Rare Categories of pairs", "version": "1.0.0", "xlabel": "Percent of total", "ylabel": "Category"},
                "descriptive_stats": {
                    "bars": {},
                    "denominator_key": "pct_of_nonnull",
                ...
                "draft_descriptive_findings": {"context": "Base = 6 non-null; K = 2 total categories", "primary_finding": "No categories meet the rare threshold.", "secondary_finding": None},
                "draft_inferential_findings": {},
                "inferential_stats": {},
            },
        ),
        ...
        (
            ...
            {
                "chart_metadata": {"data_source": "UnitTest", "file_name": None, "title": "Rare Categories of animals", "version": "1.0.0", "xlabel": "Category Name", "ylabel": "Frequency"},
                "descriptive_stats": {
                    "bars": {"cat": {"count": 1, "pct_of_nonnull": 0.16666666666666666}, "dog": {"count": 2, "pct_of_nonnull": 0.3333333333333333}},
                    "denominator_key": "pct_of_nonnull",
                    "input_categories": 2,
                    "input_nonzero_categories": 2,
                    "n_bars_rendered": 2,
...
def test_balance_rare_categories_plot_data_driven(make_series, kwargs, expect, tmp_path, assert_plot_metadata):
    ...
    ctx = BalanceRareCategoriesPlotContext(**kwargs)
    plot = BalanceRareCategoriesPlot(ctx)
