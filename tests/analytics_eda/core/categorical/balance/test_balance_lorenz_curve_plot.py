...
def test_validate_categorical_named_series_errors(series_factory, expected_exc, match):
    ...
    with pytest.raises(expected_exc, match=match):
        ctx = BalanceLorenzCurvePlotContext()
    ...
    [
        ...
        (
            ...
            {"file_name": "lorenz_skewed.png"},
            {
                ...
                "draft_descriptive_findings": {"context": "N = 13 values across 3 categories", "primary_finding": "Category imbalance measured by Gini index = 0.462 (0 = perfectly balanced, 1 = highly imbalanced).", "secondary_finding": None},
            },
        ),
        ...
        (
            ...
            {"file_name": "lorenz_severe_imbalance.png"},
            {
                ...
                "draft_descriptive_findings": {
                    ...
                    "primary_finding": lambda s: s.startswith("Category imbalance measured by Gini index = "),
...
def test_balance_lorenz_curve_plot_data_driven(make_series, kwargs, expect, tmp_path, assert_plot_metadata):
    ...
    ctx = BalanceLorenzCurvePlotContext(**kwargs)
    plot = BalanceLorenzCurvePlot(ctx)
