...
def test_validate_categorical_named_series_errors(series_factory, expected_exc, match):
    ...
    with pytest.raises(expected_exc, match=match):
        ctx = FrequencyParetoPlotContext()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            (lambda vals=["A", "A", "A", "B", "C"]: pd.Series(vals, name="cats", dtype="object")),
            {
            ...
            {
                "chart_metadata": {"file_name": "grouping_to_others.png", "title": "Pareto Chart of cats", "version": "1.0.0", "xlabel": "Category", "ylabel": "Share of total"},
                "descriptive_stats": {
                    "bars": {"A": {"count": 3, "pct_of_total": 0.6}, "Other (k=2)": {"_is_other": True, "count": 2, "k_agg": 2, "pct_of_total": 0.4}},
        ...
        (
            (lambda vals=["A", "A", "B", "C", "C", "C"]: pd.Series(vals, name="cats", dtype="object")),
            {"file_name": "horizontal_orientation.png"},
            {
                "chart_metadata": {"file_name": "horizontal_orientation.png"},
                "descriptive_stats": {
                    "bars": {"A": {"count": 2, "pct_of_total": 0.3333333333333333}, "B": {"count": 1, "pct_of_total": 0.16666666666666666}, "C": {"count": 3, "pct_of_total": 0.5}},
                    "cumulative_count_at_threshold": 5,
                    "denominator_key": "pct_of_total",
                    "input_categories": 3,
                    "input_nonzero_categories": 3,
                ...
                "draft_descriptive_findings": {"context": "N = 6 values across 3 categories", "primary_finding": "≈80% of occurrences are concentrated in the top 2 categories.", "secondary_finding": "Top category: 'C' at 50.0%."},
                "draft_inferential_findings": {},
                "inferential_stats": {},
            },
        ),
        ...
        (
            (lambda vals=["m", "m", "n", "o"]: pd.Series(vals, name="cats", dtype="object")),
            {"xlabel": "Category", "ylabel": "Frequency", "data_source": "UnitTest"},
            {
                ...
                "descriptive_stats": {
                    "bars": {"m": {"count": 2, "pct_of_total": 0.5}, "n": {"count": 1, "pct_of_total": 0.25}, "o": {"count": 1, "pct_of_total": 0.25}},
                ...
                "draft_descriptive_findings": {"context": "N = 4 values across 3 categories", "primary_finding": "≈80% of occurrences are concentrated in the top 3 categories.", "secondary_finding": "Top category: 'm' at 50.0%."},
            },
        ),
        # 4) name override
        (
            (lambda vals=["a", "a", "b"]: pd.Series(vals, name="cats", dtype="object")),
            {"name": "Products"},
            {
...
def test_frequency_pareto_plot_data_driven(make_series, kwargs, expect, tmp_path, assert_plot_metadata):
    ...
    ctx = FrequencyParetoPlotContext(**kwargs)
    plot = FrequencyParetoPlot(ctx)
