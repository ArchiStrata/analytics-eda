...
def test_validate_categorical_named_series_errors(series_factory, expected_exc, match):
    ...
    with pytest.raises(expected_exc, match=match):
        ctx = BalanceChiSquareUniformContext()
    ...
    [
        ...
        (
            ...
            {},
            {
                ...
                "chart_metadata": {
                    "file_name": None,
                    "title": "Chi-Square Goodness-of-Fit: testvar",
                    "version": "1.0.0",
                    "xlabel": "Observed − Expected (count)",
                    "ylabel": "Category"
                },
        ...
        (
            ...
            {"alpha": 0.05, "file_name": "gof_balanced_distribution.png"},
            {
                "chart_metadata": {
                    ...
                    "title": "Chi-Square Goodness-of-Fit: letters",
                    "version": "1.0.0",
                    "xlabel": "Observed − Expected (count)",
                    "ylabel": "Category"
                },
                "descriptive_stats": {
                    ...
                    "params": {
                        ...
                        "bar_top_n": 1,
                        "delta_metric": "count",
                        "label_value_format": "±count_and_ratio",
                        "sort_mode": "abs_delta"
                    },
                    "top_labels": [],
                    "total": 6
        ...
        (
            ...
            {"alpha": 0.05, "file_name": "gof_unbalanced_distribution.png"},
            {
                "chart_metadata": {
                    ...
                    "title": "Chi-Square Goodness-of-Fit: choices",
                    "version": "1.0.0",
                    "xlabel": "Observed − Expected (count)",
                    "ylabel": "Category"
                },
                "descriptive_stats": {
                    "bars": {
                        "X": {
                            "delta": 5,
                            "delta_pct_of_expected": 1.307692307692308,
                            "expected": 4.333333333333333,
                            "observed": 10,
                            "ratio_oe": 2.307692307692308,
                            "std_resid": 2.7221786146864817
                        },
                        "Y": {
                            "delta": -2,
                            "delta_pct_of_expected": -0.5384615384615384,
                            "expected": 4.333333333333333,
                            "observed": 2,
                            "ratio_oe": 0.46153846153846156,
                            "std_resid": -1.12089707663561
                        },
                        "Z": {
                            "delta": -3,
                            "delta_pct_of_expected": -0.7692307692307692,
                            "expected": 4.333333333333333,
                            "observed": 1,
                            "ratio_oe": 0.23076923076923078,
                            "std_resid": -1.6012815380508714
                        }
                    },
                    "k": 3,
                ...
                "draft_descriptive_findings": {
                    ...
                    "primary_finding": "Category frequencies deviate from a uniform expectation.",
                    "secondary_finding": "Largest absolute deviation: X (+5, O/E=2.31)."
                },
                "draft_inferential_findings": {
...
def test_balance_chi_square_uniform_plot_data_driven(make_series, kwargs, expect, tmp_path, assert_plot_metadata):
    ...
    ctx = BalanceChiSquareUniformContext(**kwargs)
    plot = BalanceChiSquareUniformPlot(ctx)
