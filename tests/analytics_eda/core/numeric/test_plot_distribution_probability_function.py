        ...
        (
            ...
            {"is_discrete": True},
            {
                ...
                "descriptive_stats": {
                    ...
                    "mode": (lambda v: np.isnan(v)),
                    "variance": (lambda v: np.isnan(v)),
...
def test_plot_distribution_probability_function_param(make_series, kwargs, expect, tmp_path, assert_plot_metadata):
    s = make_series()
    ...
    payload = plot_distribution_probability_function(s, **kwargs)
