...
@dataclass
class BalanceRareCategoriesPlotContext(SeriesBarChartContext):
    """
...
class BalanceRareCategoriesPlot(SeriesBarChartMixin, BasePlot):
    ...
    def draft_descriptive_findings(self, desc: dict[str, Any]) -> dict[str, Any]:
        ...
        findings = {"context": f"Base = {total_nonnull:,} non-null; K = {k_total} total categories", "secondary_finding": None}
