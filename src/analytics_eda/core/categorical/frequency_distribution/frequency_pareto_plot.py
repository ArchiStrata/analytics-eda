...
@dataclass
class FrequencyParetoPlotContext(SeriesBarChartContext):
...
class FrequencyParetoPlot(SeriesBarChartMixin, BasePlot):
    ...
    def compute_descriptive(self, s: pd.Series) -> dict[str, Any]:
        ...
        desc = self.build_series_bar_desc(s, counts.to_dict(), denominator_key="pct_of_total", extra_params=extra_params)
    ...
    def draft_descriptive_findings(self, desc: dict[str, Any]) -> dict[str, Any]:
        ...
        if other_in_cut:
            ...
            findings["primary_finding"] = f"≈{thr_pct_formatted} of occurrences are concentrated in the top {thr_idx + 1} categories."
