...
class ShapeQqFitPlot(BasePlot):
    ...
    def default_descriptive(self) -> dict[str, Any]:
        ...
        return {"intercept": None, "slope": None, "r_squared": None, "median_residual": None, "iqr_residual": None, "max_abs_residual": None, "skewness": None, "kurtosis": None, "min": None}
    ...
    def draw(
        ...
        *,
        ...
        if "error" in desc:
            ax.text(0.5, 0.5, f"Data domain error: {desc['error']}", transform=ax.transAxes, ha="center", va="center", bbox=dict(boxstyle="round", facecolor="white", alpha=0.6))
            return fig, ax
        ...
        ax.text(0.02, 0.98, "\n".join(lines), transform=ax.transAxes, ha="left", va="top", fontsize="small", bbox=dict(facecolor="white", alpha=0.5))
